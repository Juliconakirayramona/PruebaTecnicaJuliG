...
{
	[TestClass]
	public class RegitserParserTestServiceName
	{
		[Fact]
		public void ProccesLines_DeberiaAceptarServiceNameValida()
		{
		...
		[Fact]
		public void ProccesLines_DeberiaRechazarServiceNameNull()
		{
			...
			{
				"Id|Sequence|ServiceName|ServiceState|CashValue|TellerId|DateSettlement",
				"1|1||Accepted|1500,50|123|2026-03-18"
			};
			...
			Xunit.Assert.Contains("Nombre del Servicio inválido", result.Errores[0]);
		}
	}
}
